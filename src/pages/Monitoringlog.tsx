...
import {addMonitoringLog, deleteMonitoringLog, updateMonitoringLog} from "../reducers/MonitoringLogSlice";
    ...
    return (
        <>
            <div className="col-span-12 lg:col-span-10 p-4 fixed left-44 top-0 w-[calc(100%-176px)] h-screen overflow-y-auto">
                <h1 className="text-4xl font-bold text-center my-4">Monitoring Log Management</h1>
                ...
                <table className="table-auto w-full border border-gray-300">
                    ...
                    {mlogs.map((mLog, index) => (
                        <tr key={index}>
                            ...
                            <td className="px-4 py-2 border">
                                {new Date(mLog.logDate).toLocaleDateString()}
                            </td>
                        ...
                        <div className="p-4">
                            <form id="monitoringLogForm" className="space-y-4">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        <label htmlFor="logCode" className="block font-medium">
                                            Log Code
                                        </label>
                                        <input
                                            type="text"
                                            ...
                                            onChange={(e) =>
                                                setNewMLog({ ...newMLog, logCode: e.target.value })
                                            }
                                        />
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={(e) =>
                                                setNewMLog({ ...newMLog, observation: e.target.value })
                                            }
                                        />
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={(e) =>
                                                setNewMLog({ ...newMLog, fieldCode: e.target.value })
                                            }
                                        />
                                    </div>
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={(e) =>
                                                setNewMLog({ ...newMLog, cropCode: e.target.value })
                                            }
                                        />
                                    </div>
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={(e) =>
                                                setNewMLog({ ...newMLog, staffId: e.target.value })
                                            }
                                        />
                                    </div>
                                </div>
