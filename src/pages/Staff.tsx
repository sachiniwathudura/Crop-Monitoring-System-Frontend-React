...
import { removeStaff, addStaff, updateStaff } from "../reducers/StaffSlice";
    ...
    return (
        <>
            ...
            <div className="col-span-12 lg:col-span-10 p-4 fixed left-44 top-0 w-[calc(100%-176px)] h-screen p-4 overflow-y-auto">
                <h1 className="text-4xl font-bold text-center my-4">Staff Management</h1>
                        ...
                        <div className="p-4">
                            <form id="staffForm" className="space-y-4">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        <label htmlFor="firstName" className="block font-medium text-green-700 text-lg">
                                            First Name
                                        </label>
                                        <input
                                            type="text"
                                    ...
                                    <div>
                                        ...
                                        <input
                                            type="date"
                                            className="form-input w-full border border-gray-300 rounded-md px-4 py-2 focus:ring-2 focus:ring-blue-500 focus:outline-none color:black"
                                            id="DOB"
